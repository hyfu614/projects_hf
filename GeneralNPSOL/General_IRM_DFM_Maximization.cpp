  ...
  try
    {
      ...
      string specification_file = "./IRM_DFM/IRM_DFM_7var_3shock_specification.txt";
      //string specification_file = "IRM_6var_4shock_unrestricted_specification_generalf0_deg21.txt";
      string draws_file = "./IRM_DFM/nf4/nf4.draw.text";
      string results_dir = "./IRM_DFM/maxresults"; 	// default directory for saving results
      string output_subdir = "nf4_posterior_draws";	// default sub_directory for saving results
      bool cold_start = true;		// default: cold start for each NPSOL call

      unsigned int nDraws = 50000;
      unsigned int nMaxima = 60;
